        ...
        <div class="filters-bar">
          <div class="filters-grid">
            ...
            <select v-model="draftFilters.sort" class="filter-control">
              ...
              <option v-if="isReceivedView" value="return_received_at_desc">Received DESC</option>
              <option v-if="isReceivedView" value="return_received_at_asc">Received ASC</option>
            </select>
