<template>
  <div class="dastaq-options">
    <div class="form-grid">
      <div class="form-group">
        <label class="form-label">API Key</label>
        <p class="form-sublabel">Enter your Dastaq API key.</p>
        <input
          :value="modelValue.api_key || ''"
          type="text"
          class="form-input"
          :class="{ 'input-error': apiKeyError }"
          placeholder="Enter Dastaq API key"
      ...
      <div class="form-group">
        ...
        <p class="form-sublabel">Enter your Dastaq API secret.</p>
        <input
          :value="modelValue.api_secret || ''"
          type="password"
          class="form-input"
          :class="{ 'input-error': apiSecretError || generalError }"
          placeholder="Enter Dastaq API secret"
