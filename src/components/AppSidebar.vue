...
const baseNavItems = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: 'in-progress-report',
        label: 'In Progress Report',
        to: '/reports/in-progress',
        icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7h11v9H3Z"/><path d="M14 10h3l4 4v2h-7Z"/><circle cx="7" cy="18" r="2"/><circle cx="17" cy="18" r="2"/></svg>`,
      },
      {
        key: 'product-report',
    ...
    children: [
      {
        ...
        label: 'Overview',
        to: '/vendors',
        icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19V5"/><path d="M4 19h16"/><path d="m7 14 3-3 3 2 5-6"/></svg>`,
      },
      {
        key: 'vendors-list',
        label: 'Vendors',
      ...
      },
      {
        ...
        label: 'Payments',
        to: '/vendors/payments',
        icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M7 15h.01"/><path d="M11 15h2"/><path d="M17 9h.01"/></svg>`,
      },
      {
        key: 'vendor-ledger',
        label: 'Ledger',
        to: '/vendors/ledger',
        icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z"/><path d="M8 8h8"/><path d="M8 12h8"/><path d="M8 16h5"/></svg>`,
      },
      {
        key: 'vendor-average-cost',
        label: 'Average Cost',
        to: '/vendors/average-cost',
        icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7H14a3.5 3.5 0 0 1 0 7H6"/></svg>`,
      },
    ],
