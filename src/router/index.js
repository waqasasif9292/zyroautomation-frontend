...
const routes = [
  ...
  { path: '/settings/preferences', component: () => import('../pages/settings/SettingsPage.vue'), meta: { requiresAuth: true, settingsTab: 'preferences', adminOnly: true } },
  ...
  { path: '/vendors', component: () => import('../pages/vendors/VendorsWorkspacePage.vue'), meta: { requiresAuth: true, vendorTab: 'overview' } },
  { path: '/vendors/list', component: () => import('../pages/vendors/VendorsWorkspacePage.vue'), meta: { requiresAuth: true, vendorTab: 'vendors' } },
  { path: '/vendors/orders', component: () => import('../pages/vendors/VendorsWorkspacePage.vue'), meta: { requiresAuth: true, vendorTab: 'orders' } },
  { path: '/vendors/payments', component: () => import('../pages/vendors/VendorsWorkspacePage.vue'), meta: { requiresAuth: true, vendorTab: 'payments' } },
  { path: '/vendors/ledger', component: () => import('../pages/vendors/VendorsWorkspacePage.vue'), meta: { requiresAuth: true, vendorTab: 'ledger' } },
  { path: '/vendors/average-cost', component: () => import('../pages/vendors/VendorsWorkspacePage.vue'), meta: { requiresAuth: true, vendorTab: 'average-cost' } },
  ...
  { path: '/whatsapp', component: () => import('../pages/WhatsAppConnectionPage.vue'), meta: { requiresAuth: true } },
